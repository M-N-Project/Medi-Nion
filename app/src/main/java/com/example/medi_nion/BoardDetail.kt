    ...
    fun fetchMedalData() {
        ...
        val request = Login_Request(
            ...
            { response ->
                ...
                when (response) {
                    "king" -> {
                        medalImage.setImageResource(R.drawable.grade_diamond2)
                    }
                    "gold" -> {
                        medalImage.setImageResource(R.drawable.grade_gold2)
                    }
                    "silver" -> {
                        medalImage.setImageResource(R.drawable.grade_silver2)
                    }
                    else -> {
                        medalImage.setImageResource(R.drawable.grade_bronze2)
                    }
                }
...
//                                                        var comment2HeartArray = comment2HeartMap[item1]
                                                    ...
                                                    val requestComment2List = Login_Request(
                                                        ...
                                                        urlDetail,
                                                        { response ->
                                                            Log.d("**!대댓글 fetch", "$comment_num")
                                                            Log.d("**!대댓글 fetch", response)
                                                            commentDetail_items.clear()
                                                            comment2_count.clear()
                                                            if (response != "Comment2 Fetch fail") {
                                                                ...
                                                                //대댓글 없으면 -> 그냥 commentItem add 해주기
                                                                Log.d("**! 댓글 개수", jsonArrayComment2.length().toString())

                                                                if(jsonArrayComment2.length() <= 0){
                                                                    if (!comment_user.containsKey(writerId)) comment_user[writerId] =
                                                                        comment_user.size + 1
...
//                                                                                    item.getString("id")
                                                                                ...
                                                                                val request = Login_Request(
                                                                                    ...
                                                                                    { medalresponse ->
                                                                                        ...
                                                                                        Log.d("**!댓글 item", commentItem.comment)
                                                                                        ...
                                                                                        Commentadapter =
                                                                                            CommentListAdapter(comment_items)
                                                                                        Log.d("**!!댓글 item List", comment_items.size.toString())
                                                                                        CommentRecyclerView.adapter =
                                                                                            Commentadapter
                                                                                        ...
                                                                                        Commentadapter.setOnItemClickListener(
                                                                                            object :
                                                                                                ...
                                                                                                override fun onItemClick(
                                                                                                    ...
                                                                                                    Log.d("01983123", "대댓글 없을때 댓글 click")
                                                                                                    //댓글 눌렀을때. -> 대댓글
...
//                                                                                                            data.comment_num
                                                                                                ...
                                                                                                override fun onItemDelete(
                                                                                                    ...
                                                                                                    Log.d("itemDelete", "대댓글 없을때 댓글 삭제")
                                                                                                        ...
                                                                                                        .setPositiveButton("삭제",
                                                                                                            DialogInterface.OnClickListener { dialog, id ->
                                                                                                                ...
                                                                                                                val requestComment2Count = Login_Request(
                                                                                                                    ...
                                                                                                                    urlComment2Count,
                                                                                                                    { urlComment2Count ->
                                                                                                                        Log.d("commm1", urlComment2Count)
                                                                                                                        if(urlComment2Count != "comment2 count fail"){
                                                                                                                            val jsonObject = JSONObject(urlComment2Count)
                                                                                                                            val comment2Count = jsonObject.getInt("count")
                                                                                                                                                                                ...
                                                                                                                                                                                if (i == comment2Count) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    findViewById<TextView>(
                                                                                                                                                                                        ...
                                                                                                                                                                                        (findViewById<TextView>(
                                                                                                                                                                                            ...
                                                                                                                                                                                            .toInt() - (comment2Count+1)).toString()
...
//                                                                                                                                                }
                                                                                                                ...
                                                                                                                val queue = Volley.newRequestQueue(applicationContext)
                                                                                                                queue.add(requestComment2Count)
                                                                                                            })
...
//                                                                    queue1.add(request1)
                                                                ...
                                                                //대댓글 있으면 -> 대댓글이 다 더해진 후에 CommentItem add 하게끔 만들기
                                                                    ...
                                                                    Log.d("00123", jsonArrayComment2.length().toString())
...
//                                                                if(comment2HeartMap[comment_num] == comment2_num) isHeart = true
                                                                        ...
                                                                        if (comment2HeartMap.contains(
                                                                                comment_num
                                                                            )
                                                                        ) {
                                                                            if (comment2HeartMap[comment_num]!!.contains(
                                                                                    comment2_num
                                                                                )
                                                                            ) {
                                                                                isHeart = true
                                                                        ...
                                                                        val comment2medalurl =
                                                                            "http://seonho.dothome.co.kr/Medal_Select.php"
                                                                        val id =
                                                                            intent.getStringExtra("id")
                                                                                .toString()
                                                                        var post_num =
                                                                        ...
                                                                        val request =
                                                                            Login_Request(
                                                                                ...
                                                                                { medal2response ->
                                                                                    ...
                                                                                    if (commentDetailItemsMap.contains(
                                                                                            comment_num
                                                                                        )
                                                                                    ) {
                                                                                        commentDetailItemsMap[comment_num]!!.add(
                                                                                            commentDetailItem
                                                                                        )
                                                                                    } else {
                                                                                        commentDetailItemsMap[comment_num] =
                                                                                            ArrayList<CommentDetailItem>()
                                                                                        commentDetailItemsMap[comment_num]!!.add(
                                                                                            commentDetailItem
                                                                                        )
                                                                                    }
                                                                                                                            ...
                                                                                                                            if (responseDelete2 != "comment2 delete fail") {
                                                                                                                                ...
                                                                                                                                val requestDeleteCount =
                                                                                                                                    Login_Request(
                                                                                                                                        ...
                                                                                                                                        urlCommentDeleteCount,
                                                                                                                                        { requestDeleteCount ->
                                                                                                                                            Log.d("requesttDee",requestDeleteCount)
                                                                                                                                            if (requestDeleteCount != "update fail") {
                                                                                                                                                commentFlagHash[comment_num] = false
                                                                                                                                                Toast.makeText(
                                                                                                                                                    baseContext,
                                                                                                                                                    String.format(
                                                                                                                                                        "대댓글이 삭제되었습니다."
                                                                                ...
                                                                                for (i in 0 until jsonArray.length()) {
                                                                                    ...
                                                                                    val request = Login_Request(
                                                                                        ...
                                                                                        { medalresponse ->
                                                                                            ...
                                                                                            Log.d("**! 댓글 flag", commentFlagHash[comment_num].toString())
...
//                                                                                                                pos
                                                                                                        ...
                                                                                                        override fun onItemDelete(
                                                                                                            ...
                                                                                                            Log.d("itemDelete", "대댓글 있을때 댓글 삭제")
                                                                                                            val builder = AlertDialog.Builder(this@BoardDetail)
                                                                                                            builder.setTitle("댓글 삭제")
                                                                                                                .setMessage("댓글을 삭제하시겠습니까?")
                                                                                                                .setPositiveButton("삭제",
                    ...
                    val requestCnt = Login_Request(
                        ...
                        { responseComment ->
                            if (!responseComment.equals("update fail")) {
                                ...
                                Log.d("comment2_count", comment2_count[comment_num].toString())
