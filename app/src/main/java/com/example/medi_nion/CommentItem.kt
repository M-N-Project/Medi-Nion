...
class CommentItem(val id : String, val writerId: String, val writerNum : Int, val comment: String, val comment_medal: String, val comment_num: Int, val comment_time: String, val commentHeart : Int, val isHeart : Boolean?,  val commentDetailAdapter : CommentDetailListAdapter?) {
