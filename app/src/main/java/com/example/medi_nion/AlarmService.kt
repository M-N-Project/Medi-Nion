...
//    )
//
//    builder = NotificationCompat.Builder(context, AlarmReceiver.CHANNEL_ID)
//
//    val notificationIntent = Intent(context, CalendarFragment::class.java)
//    val requestCode = intent?.extras!!.getInt("alarm_rqCode")
//    val title = intent.extras!!.getString("content")
//
//    val pendingIntent: PendingIntent = PendingIntent.getActivity(context,
//        AlarmReceiver.ALARM_REQUEST_CODE, notificationIntent, PendingIntent.FLAG_MUTABLE
//    )
//    if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.S){
//        PendingIntent.getActivity(context,requestCode,notificationIntent,PendingIntent.FLAG_IMMUTABLE); //Activity를 시작하는 인텐트 생성
