...
class Agreement : AppCompatActivity() { //mainactivity, 여기서는 프레그먼트 제어를 담당

    override fun onCreate(savedInstanceState: Bundle?) { //프레그먼트로 생길 문제들은 추후에 생각하기,,
        super.onCreate(savedInstanceState)
        setContentView(R.layout.agreement)

        var allAgreeBtn = findViewById<CheckBox>(R.id.allAgreeBtn)
        allAgreeBtn.setButtonDrawable(R.drawable.checkbtn_round)
        var agreeBtn1 = findViewById<CheckBox>(R.id.agreeBtn1)
        agreeBtn1.setButtonDrawable(R.drawable.checkbtn_round)
        var agreeBtn2 = findViewById<CheckBox>(R.id.agreeBtn2)
        agreeBtn2.setButtonDrawable(R.drawable.checkbtn_round)
        var agreeBtn3 = findViewById<CheckBox>(R.id.agreeBtn3)
        agreeBtn3.setButtonDrawable(R.drawable.checkbtn_round)
        var agreeBtn4 = findViewById<CheckBox>(R.id.agreeBtn4)
        agreeBtn4.setButtonDrawable(R.drawable.checkbtn_round)

        var agreeDetailBtn1 = findViewById<Button>(R.id.agreeDeatil1)
        var agreeDetailBtn2 = findViewById<Button>(R.id.agreeDeatil2)
        var agreeDetailBtn3 = findViewById<Button>(R.id.agreeDeatil3)
        var agreeDetailBtn4 = findViewById<Button>(R.id.agreeDeatil4)

        agreeDetailBtn1.setOnClickListener{
            //이용약관동의 상세
            val builder = AlertDialog.Builder(this)
            builder.setTitle("이용약관동의 상세")
                .setMessage("제 1 장 총칙\n" +
                        "\n" +
                        "제 1 조 (목적)\n" +
        ...
        agreeDetailBtn2.setOnClickListener{
            //개인정보 수집 및 활용 동의 상세

            val builder = AlertDialog.Builder(this)
            builder.setTitle("개인정보 수집 및 활용 동의 상세")
                .setMessage("1. 개인정보의 수집항목 및 수집방법 \n" +
        ...
        agreeDetailBtn3.setOnClickListener{
            //광고성 정보 수집 동의 상세
        }

        agreeDetailBtn4.setOnClickListener{
            //위치 정보 동의 상세
        }
        ...
        allAgreeBtn.setOnClickListener{
            agreeBtn1.isChecked = allAgreeBtn.isChecked
            agreeBtn2.isChecked = allAgreeBtn.isChecked
            agreeBtn3.isChecked = allAgreeBtn.isChecked
            agreeBtn4.isChecked = allAgreeBtn.isChecked

        }

        agreeBtn1.setOnClickListener{
            agreeBtn1.isSelected = !agreeBtn1.isChecked
        }

        agreeBtn2.setOnClickListener{
            agreeBtn2.isSelected = !agreeBtn2.isChecked
        }

        agreeBtn3.setOnClickListener{
            agreeBtn3.isSelected = !agreeBtn3.isChecked
        }

        agreeBtn4.setOnClickListener{
            agreeBtn4.isSelected = !agreeBtn4.isChecked
        }

        if(agreeBtn1.isChecked==true && agreeBtn2.isChecked==true && agreeBtn3.isChecked==true && agreeBtn4.isChecked==true )
            allAgreeBtn.isChecked = true
        allAgreeBtn.setButtonDrawable(R.drawable.checkbtn_round)


        var agreeNextBtn = findViewById<Button>(R.id.agreeNextBtn)
        agreeNextBtn.setOnClickListener{
            if(agreeBtn1.isChecked!=true || agreeBtn2.isChecked!=true) {
                val builder = AlertDialog.Builder(this)
            ...
            else if(agreeBtn3.isChecked!=true || agreeBtn4.isChecked != true){
                val builder = AlertDialog.Builder(this)
