...
class BusinessSubListProfileAdapter(private val itemList : ArrayList<BusinessChanListItem>) : RecyclerView.Adapter<BusinessSubListProfileAdapter.ViewHolder>()  {
    ...
    fun setOnItemClickListener(listener: BusinessSubListProfileAdapter.OnItemClickListener) {
